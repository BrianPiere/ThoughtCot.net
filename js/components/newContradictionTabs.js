...
postInit(function(){
	...
	componentObj.addHtmlGenerator(function(elementIdOfComponentInstanceWrapper, componentPropertiesObj, stateSlicesObj){
		...
		retHtml += "<h4 class='title respond-to-title sm-top xs-left'>"+dialogMessageTitle+"</h4><div class='new-message-responding-to-message light-blue-bck xs-top xs-btm xs-left xs-right'>" + HIPI.framework.Utilities.htmlizeStringWithLineBreaks(stateSlicesObj.respondToMessage) + "</div>";
